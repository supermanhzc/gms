...
public class UserController extends TyBaseController implements UserApi {
    ...
    @Override
    @OperControllerLog(key = OperLogKeyConsts.GMS_QUERY_ADMINS_KEY, module = "用户管理", type = "创建管理员")
    ...
    @Override
    @OperControllerLog(key = OperLogKeyConsts.GMS_QUERY_USERS_KEY, module = "用户管理", type = "查询普通会员")
    ...
    @Override
    @OperControllerLog(key = OperLogKeyConsts.GMS_QUERY_PROXYS_KEY, module = "用户管理", type = "查询代理会员")
    ...
    @Override
    public TyResponse getUserLoginHistory(TyPageEntity queryAdminRequest) {
        return null;
    }

    @Override
    public TyResponse getProxyLoginHistory(TyPageEntity queryAdminRequest) {
        return null;
    }
}
